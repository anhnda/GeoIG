...
RECOMMENDED USAGE:
  python geo_v2.py --data_dir ./data/saliency_imagenet1k_resnet50_100 \\
    ...
    parser.add_argument('--use_edge_gating', dest='use_edge_gating', action='store_true', default=True,
                       help='Use edge-aware attention gating (DEFAULT: OFF for s2)')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints_s3',
                       help='Checkpoint directory (default: ./checkpoints_s3)')
